...
class Create {
    ...
    public function template() {
        try {
            $this->container->app->get('/locatarios/cadastrar', function (Request $request, Response $response, $args) {
                return $this->container->renderer->render($response, 'cadastrarLocatarios.html', $args);
            });
        } catch(\Exception $ex) {
    ...
    public function post() {
        try {
            $this->container->app->post('/locatarios/salvar', function (Request $request, Response $response, $args) {
